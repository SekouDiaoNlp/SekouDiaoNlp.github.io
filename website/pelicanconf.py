...
PROJECTS = [{
    ...
    {'name': 'pylexique',
     ...
     'description': 'Pylexique is a python library allowing to access the lexical information of more than 140000 French words.'},
    {'name': 'potranslator3',
    ...
    {'name': 'PyPi',
     'url': 'https://pypi.org/user/SekouDiaoNlp/',
     'description': 'My PyPi profile.'},
    {'name': 'conda-forge',
